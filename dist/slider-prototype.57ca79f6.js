...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"slider-prototype.js":[function(require,module,exports) {
function Slider(slider) {
  ...
  this.slider = slider; // Create variable for working with the slider 
  // let this.prev;
  // let this.current;
  // let this.next;
...
Slider.prototype.move = function (direction) {
  ...
  var classesToRemove = ['prev', 'current', 'next']; // [prev, current, next].forEach(el => el.classList.remove(...classesToRemove))
  ...
  if (direction === 'back') {
    var _ref = [this.prev.previousElementSibling || this.slides.lastElementChild, this.prev, this.current];
    this.prev = _ref[0];
    this.current = _ref[1];
    this.next = _ref[2];
  } else {
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","slider-prototype.js"], null)
//# sourceMappingURL=/slider-prototype.57ca79f6.js.map